...
export default function GuestLayout({ children }) {
    ...
    return (
        <div className="min-h-screen flex bg-slate-50">
            ...
            <div className="hidden lg:flex lg:w-5/12 bg-forest relative overflow-hidden flex-col justify-between p-12 text-white border-r border-slate-800">
                {/* Decorative gradients */}
                <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-gradient-to-br from-[#c9a84c]/20 to-transparent rounded-full blur-[100px] pointer-events-none animate-pulse duration-10000"></div>
                <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-gradient-to-tr from-forest/40 to-transparent rounded-full blur-[100px] pointer-events-none"></div>

                {/* Logo & Header */}
                <div className="relative z-10">
                    <Link href="/" className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gold rounded-xl flex items-center justify-center border border-gold/30 overflow-hidden shadow-lg">
                        ...
                        <div>
                            ...
                            <span className="text-gold text-[10px] font-bold uppercase tracking-widest block -mt-1">PH 18 LAMPUNG</span>
                        </div>
                    </Link>
                </div>
                ...
                <div className="relative z-10 my-auto space-y-8">
                    <div className="space-y-4">
                        <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 border border-gold/30 text-gold text-xs font-bold uppercase tracking-wider">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={i} className="flex gap-3.5 items-start">
                                <div className="w-8 h-8 rounded-lg bg-white/5 border border-gold/30 flex items-center justify-center shrink-0 text-sm">
                                    {feat.icon}
                                </div>
                                <div>
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 bg-gradient-to-br from-slate-50 to-slate-100 relative overflow-y-auto">
                <div className="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none">
                    <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-gold/20 rounded-full blur-[120px] mix-blend-multiply opacity-70"></div>
                    <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-forest/20 rounded-full blur-[120px] mix-blend-multiply opacity-70"></div>
                </div>

                {/* Mobile Logo Header */}
                <div className="lg:hidden mb-8 text-center flex flex-col items-center">
                    <Link href="/">
                        <div className="w-16 h-16 bg-gold rounded-2xl flex items-center justify-center border border-gold/30 overflow-hidden shadow-lg">
                            <img src="/images/logo 2.jpeg" alt="Logo Kospart" className="w-full h-full object-cover" />
                        </div>
                    </Link>
                    <span className="font-extrabold text-2xl tracking-tight text-slate-900 mt-3 block">KOSPART</span>
                    <span className="text-forest text-xs font-bold tracking-widest uppercase block -mt-1">PH 18 LAMPUNG</span>
                </div>

                {/* Form card */}
                <div className="w-full max-w-md bg-white/70 backdrop-blur-2xl rounded-3xl border border-white shadow-[0_8px_40px_rgba(0,0,0,0.04)] p-8 relative z-10 transition-all duration-500 hover:shadow-[0_16px_50px_rgba(201,168,76,0.15)]">
                    {children}
                </div>
