...
export default function Rooms({ branches, rooms, auth }) {
    ...
    return (
        <div className="min-h-screen bg-lux text-slate-700 flex flex-col font-sans selection:bg-[#2d6a4f] selection:text-white" style={{ position: 'relative' }}>
            ...
            {/* ── HERO BANNER ── */}
            <section className="lux-hero lux-texture border-b border-[rgba(201,168,76,0.1)] py-10 md:py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="space-y-4">
                            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-forest leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
                                Temukan Kamar<br /><span className="italic text-gold">Impian Anda</span>
                            </h1>
