                        ...
                        {bookingStep === 'booking' && (
                            <form onSubmit={handleBookingSubmit} className="p-6 space-y-4">
                                ...
                                <label className="flex items-start gap-3 cursor-pointer p-3 rounded-xl hover:bg-slate-50 border border-transparent hover:border-[rgba(201,168,76,0.2)] transition-all">
                                    ...
                                    <span className="text-xs text-slate-500 leading-relaxed">Saya setuju dengan <a href="/Syarat_dan_Ketentuan_Kospart_PH_18.pdf" target="_blank" rel="noopener noreferrer" className="text-[#2d6a4f] font-bold underline hover:text-emerald-700">Syarat & Ketentuan</a> dan peraturan tata tertib Kospart PH 18. Data yang saya berikan adalah benar.</span>
                                </label>
                                    ...
                                    <div className="space-y-2 text-center">
                                        <div className="flex justify-center gap-2" onPaste={(e) => {
                                            ...
                                            if (pastedData.length === 6) {
                                                document.getElementById('otp-rooms-5')?.focus();
                                            }
                                        }}>
                                            {[0, 1, 2, 3, 4, 5].map((index) => (
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        if (val && index < 5) document.getElementById(`otp-rooms-${index + 1}`)?.focus();
                                                    }}
                                                    onKeyDown={(e) => {
                                                        if (e.key === 'Backspace' && !otpCodeInput[index] && index > 0) {
                                                            document.getElementById(`otp-rooms-${index - 1}`)?.focus();
                                                        }
                                                    }}
