...
export default function Welcome({ branches, rooms, faqs, virtualTours = [], testimonials = [], auth }) {
    ...
    const waBookingText = `https://wa.me/${waNumber}?text=Halo%20Kospart%20PH%2018%2C%20saya%20ingin%20tanya%20tentang%20kamar%20kos.`;
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-20">
                    <Reveal className="max-w-2xl space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            ...
                            <a href={waLink} target="_blank" rel="noopener noreferrer" className="bg-black/20 backdrop-blur-md border border-white/30 text-white hover:bg-black/40 px-8 py-4 rounded-full font-bold text-base flex items-center gap-2 hover:scale-105 transition-all shadow-lg shadow-black/20">
                                Tanya Admin
                            </a>
                        </div>
                    </Reveal>
                    ...
                    <div className="grid md:grid-cols-2 gap-14 items-center mb-16">
                        <SlideReveal from="left" className="space-y-5">
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                                ...
                                <a href={waLink} target="_blank" rel="noopener noreferrer" className="lux-btn-outline px-5 py-3 text-sm flex items-center gap-2">
                        ...
                        {bookingStep === 'payment_proof' && (
                            <form onSubmit={handleUploadPayment} className="p-6 space-y-4">
                                <div className="bg-[rgba(45,106,79,0.06)] p-4 rounded-xl border border-[rgba(45,106,79,0.15)] text-xs text-[#1a3d2b] leading-relaxed">
                                    ...
                                    <ul className="list-disc pl-5 mt-1 mb-2 space-y-1 font-bold"><li>{bankName}: {bankNumber} a.n {bankHolder}</li></ul>
                                </div>
                                <div className="space-y-1">
