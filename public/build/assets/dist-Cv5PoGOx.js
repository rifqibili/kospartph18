import{c as e,n as t,p as n}from"./app-ChewKqt9.js";var r=`#version 300 es
...
`,h={simplex:1,warp:2,dots:3,wave:4,ripple:5,swirl:6,sphere:7},g={random:1,"2x2":2,"4x4":3,"8x8":4};function _(e){if(Array.isArray(e))return e.length===4?e:e.length===3?[...e,1]:C;if(typeof e!=`string`)return C;let t,n,r,i=1;if(e.startsWith(`#`))[t,n,r,i]=v(e);else if(e.startsWith(`rgb`))[t,n,r,i]=y(e);else if(e.startsWith(`hsl`))[t,n,r,i]=x(b(e));else return console.error(`Unsupported color format`,e),C;return[S(t,0,1),S(n,0,1),S(r,0,1),S(i,0,1)]}function v(e){return e=e.replace(/^#/,``),e.length===3&&(e=e.split(``).map(e=>e+e).join(``)),e.length===6&&(e+=`ff`),[parseInt(e.slice(0,2),16)/255,parseInt(e.slice(2,4),16)/255,parseInt(e.slice(4,6),16)/255,parseInt(e.slice(6,8),16)/255]}function y(e){let t=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i);return t?[parseInt(t[1]??`0`)/255,parseInt(t[2]??`0`)/255,parseInt(t[3]??`0`)/255,t[4]===void 0?1:parseFloat(t[4])]:[0,0,0,1]}function b(e){let t=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i);return t?[parseInt(t[1]??`0`),parseInt(t[2]??`0`),parseInt(t[3]??`0`),t[4]===void 0?1:parseFloat(t[4])]:[0,0,0,1]}function x(e){let[t,n,r,i]=e,a=t/360,o=n/100,s=r/100,c,l,u;if(n===0)c=l=u=s;else{let e=(e,t,n)=>(n<0&&(n+=1),n>1&&--n,n<1/6?e+(t-e)*6*n:n<1/2?t:n<2/3?e+(t-e)*(2/3-n)*6:e),t=s<.5?s*(1+o):s+o-s*o,n=2*s-t;c=e(n,t,a+1/3),l=e(n,t,a),u=e(n,t,a-1/3)}return[c,l,u,i]}var S=(e,t,n)=>Math.min(Math.max(e,t),n),C=[0,0,0,1],w=n(e(),1);function T(e){let t=w.useRef(void 0),n=w.useCallback(t=>{let n=e.map(e=>{if(e!=null){if(typeof e==`function`){let n=e,r=n(t);return typeof r==`function`?r:()=>{n(null)}}return e.current=t,()=>{e.current=null}}});return()=>{n.forEach(e=>e?.())}},e);return w.useMemo(()=>e.every(e=>e==null)?null:e=>{t.current&&=(t.current(),void 0),e!=null&&(t.current=n(e))},e)}function E(e){if(e.naturalWidth<1024&&e.naturalHeight<1024){if(e.naturalWidth<1||e.naturalHeight<1)return;let t=e.naturalWidth/e.naturalHeight;e.width=Math.round(t>1?1024*t:1024),e.height=Math.round(t>1?1024:1024/t)}}var D=t();async function O(e){let t={},n=[],r=e=>{try{return e.startsWith(`/`)||new URL(e),!0}catch{return!1}},i=e=>{try{return e.startsWith(`/`)?!1:new URL(e,window.location.origin).origin!==window.location.origin}catch{return!1}};return Object.entries(e).forEach(([e,a])=>{if(typeof a==`string`){let o=a||`data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==`;if(!r(o)){console.warn(`Uniform "${e}" has invalid URL "${o}". Skipping image loading.`);return}let s=new Promise((n,r)=>{let a=new Image;i(o)&&(a.crossOrigin=`anonymous`),a.onload=()=>{E(a),t[e]=a,n()},a.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${o}`),r()},a.src=o});n.push(s)}else a instanceof HTMLImageElement&&E(a),t[e]=a}),await Promise.all(n),t}var k=(0,w.forwardRef)(function({fragmentShader:e,uniforms:t,webGlContextAttributes:n,speed:r=0,frame:i=0,width:o,height:s,minPixelRatio:c,maxPixelCount:l,mipmaps:u,style:d,...f},p){let[m,h]=(0,w.useState)(!1),g=(0,w.useRef)(null),_=(0,w.useRef)(null),v=(0,w.useRef)(n);return(0,w.useEffect)(()=>((async()=>{let n=await O(t);g.current&&!_.current&&(_.current=new a(g.current,e,n,v.current,r,i,c,l,u),h(!0))})(),()=>{_.current?.dispose(),_.current=null}),[e]),(0,w.useEffect)(()=>{let e=!1;return(async()=>{let n=await O(t);e||_.current?.setUniforms(n)})(),()=>{e=!0}},[t,m]),(0,w.useEffect)(()=>{_.current?.setSpeed(r)},[r,m]),(0,w.useEffect)(()=>{_.current?.setMaxPixelCount(l)},[l,m]),(0,w.useEffect)(()=>{_.current?.setMinPixelRatio(c)},[c,m]),(0,w.useEffect)(()=>{_.current?.setFrame(i)},[i,m]),(0,D.jsx)(`div`,{ref:T([g,p]),style:o!==void 0||s!==void 0?{width:typeof o==`string`&&isNaN(+o)===!1?+o:o,height:typeof s==`string`&&isNaN(+s)===!1?+s:s,...d}:d,...f})});k.displayName=`ShaderMount`;var A={name:`Default`,params:{...f,speed:1,frame:0,scale:.6,colorBack:`#000000`,colorFront:`#00b2ff`,shape:`sphere`,type:`4x4`,size:2}};({...f}),{...f},{...d},{...d},{...d};var j=(0,w.memo)(function({speed:e=A.params.speed,frame:t=A.params.frame,colorBack:n=A.params.colorBack,colorFront:r=A.params.colorFront,shape:i=A.params.shape,type:a=A.params.type,pxSize:o,size:s=o===void 0?A.params.size:o,fit:c=A.params.fit,scale:l=A.params.scale,rotation:u=A.params.rotation,originX:d=A.params.originX,originY:f=A.params.originY,offsetX:v=A.params.offsetX,offsetY:y=A.params.offsetY,worldWidth:b=A.params.worldWidth,worldHeight:x=A.params.worldHeight,...S}){let C={u_colorBack:_(n),u_colorFront:_(r),u_shape:h[i],u_type:g[a],u_pxSize:s,u_fit:p[c],u_scale:l,u_rotation:u,u_offsetX:v,u_offsetY:y,u_originX:d,u_originY:f,u_worldWidth:b,u_worldHeight:x};return(0,D.jsx)(k,{...S,speed:e,frame:t,fragmentShader:m,uniforms:C})});export{j as Dithering};